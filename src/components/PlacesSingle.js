                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="destination">
                                                <a href="hotel-single.html" class="img img-2" style={{ backgroundImage: `url('./images/room-4.jpg')` }}></a>
                                                <div class="text p-3">
                                                    <div class="d-flex">
                                                        <div class="one">
                                        ...
                                        <div class="col-md-4">
                                            <div class="destination">
                                                <a href="hotel-single.html" class="img img-2" style={{ backgroundImage: `url('./images/room-5.jpg')` }}></a>
                                                <div class="text p-3">
                                                    <div class="d-flex">
                                                        <div class="one">
                                                            <h3><a href="hotel-single.html">Hotel, Italy</a></h3>
                                        ...
                                        <div class="col-md-4">
                                            <div class="destination">
                                                <a href="hotel-single.html" class="img img-2" style={{ backgroundImage: `url('./images/room-6.jpg')` }}></a>
                                                <div class="text p-3">
                                                    <div class="d-flex">
                                                        <div class="one">
                                                            <h3><a href="hotel-single.html">Hotel, Italy</a></h3>
